...
.star_score { background:url(/assets/images/evaluation/stark2.png); width:160px; height:21px;  position:relative; }
.star_score a{ height:21px; display:block; text-indent:-999em; position:absolute;left:0;}
.star_score a:hover{ background:url(/assets/images/evaluation/stars2.png);left:0;}
.star_score a.clibg{ background:url(/assets/images/evaluation/stars2.png);left:0;}
#starttwo .star_score { background:url(/assets/images/evaluation/starky.png);}
#starttwo .star_score a:hover{ background:url(/assets/images/evaluation/starsy.png);left:0;}
#starttwo .star_score a.clibg{ background:url(/assets/images/evaluation/starsy.png);left:0;}
/*星星样式*/
...
.atar_Show{background:url(/assets/images/evaluation/stark2.png); width:160px; height:21px;  position:relative; float:left; }
.atar_Show p{ background:url(/assets/images/evaluation/stars2.png);left:0; height:21px; width:134px;}
...
<body>
    ...
    <div id="startone"  class="block clearfix" style="padding-left: 0px;">
          ...
          <p style="float:left;color:#ffffff;" >您的评分：<span class="fenshu" ></span> 分</p>
