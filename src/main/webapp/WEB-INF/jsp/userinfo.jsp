		...
		<div class="container">
			...
			<form action="#" method="post">
				<div class="welcome-hero-serch-box"
					...
					<div class="welcome-hero-form" style="margin-top: 5px;">
						<div class="single-welcome-hero-form" style="width: 100%;">
							<h3>电话号码</h3>
							<input type="text" name="tel" id="tel" value="${tel}"> <span></span>
						</div>
					</div>
					<div class="welcome-hero-form" style="margin-top: 5px;">
						<div class="single-welcome-hero-form" style="width: 100%;">
				...
				<button class="welcome-hero-btn" type="button"
					style="margin-top: 15px;" id="changeInfo">修改信息</button>
				<button class="welcome-hero-btn" type="button"
					style="margin-top: 15px;" id="changePassword">修改密码</button>
			</form>
		</div>
	</section>
									...
									.blur(
											function() {
												...
												if (!email
													...
													$(this)
															.after(
																	"<span id='emailValidSpan' style='color:red'>邮箱格式不正确</span>");
												} else {
													$("#emailValidSpan")
															.remove();
												}
											...
											function() {
												...
												$
														.ajax({
															...
															dataType : "json",
															success : function() {
																location.href = "/Personal/goEmail?email="
																		+ $(
																				"#email")
																				.val();
															},
															error : function() {
																window.location.href = "/Personal/goEmail?email="
																		+ $(
																				"#email")
																				.val();
															}
